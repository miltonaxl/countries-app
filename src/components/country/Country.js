...
const Country = React.memo(({ history }) => {
  ...
  const [{ data, loading, error }, setcountry] = useState({
    loading: true,
    data: null,
    error: null,
  });
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        {loading ? <Loading /> : <Card {...data} setShowModal={setShowModal} />}
      </div>
      <div
      ...
      <>
        ...
        <div className="card-body">
            ...
            <p>
              ...
              {borders.length !== 0 && (
                <div className="borders-group">
                  {borders.map((borde) => (
                    <div key={borde} className="borders">
                      {" "}
                      {borde}{" "}
                    </div>
                  ))}
          ...
          <button
            ...
            className={`btnMap ${
              bgDark
                ? "border-gray-400 rounded-lg border-2 hover:border-gray-100 text-gray-400 hover:text-gray-100 a"
                : "border-gray-400 rounded-lg border-2 hover:border-gray-800 text-gray-400 hover:text-gray-800 b"
            }`}
          >
            View Map
          </button>
